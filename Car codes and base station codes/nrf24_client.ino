...
void loop()
{
  ...
  uint8_t ForwardCommand[]="Forward!\0";
 uint8_t BackCommand[]="Back!\0";
 uint8_t StopCommand[]="Stop!\0";
 uint8_t LeftCommand[]="Left!\0";
 uint8_t RightCommand[]="Right!\0";
  //
  if(!newData)
  {
  ...
  else
  {
    ...
    else if((char)receivedChar =='s' ||(char)receivedChar =='S' ||(char)receivedChar =='0' )
    {
